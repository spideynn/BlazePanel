package net.spideynn.java.blazepanel.serverapi.console;

import net.spideynn.java.blazepanel.serverapi.Activity;
import net.spideynn.java.blazepanel.serverapi.Reference;
import net.spideynn.java.blazepanel.serverapi.Server;
import net.spideynn.java.blazepanel.serverapi.console.command.*;
...
public final class Console {
    ...
    public static void console() {
        ...
        // Register Passives:
        registerPassive(new net.spideynn.java.blazepanel.serverapi.console.command.StopCommand());

        // Register Overrides:
        registerOverride(new ExitCommand());
        registerOverride(new ListCommand());
        registerOverride(new LogCommand());
        registerOverride(new SelectCommand());
        registerOverride(new BackupCommand());
        registerOverride(new RestoreWorldCommand());

        // Input loop (I'm still not a fan of while true, but it seems to work well.)
        while (true) {
            System.out.print("ServerMagic " + net.spideynn.java.blazepanel.serverapi.Reference.version + " > " + current_server.server_name + " (Server #" + current_server.server_id + ") > ");
